...
function getUnexpectedStateShapeWarningMessage(
  ...
  if (reducerKeys.length === 0) {
    return (
      ...
      'to combineReducersImmutable is an object whose values are reducers.'
    )
  }
...
export default function combineReducersImmutable<M>(
  reducers: M
  ...
  ? Reducer<
    ...
    >
  : never
export default function combineReducersImmutable(reducers: {
  [key: string]: Reducer<any, any, any>
}) {
  const reducerKeys = Object.keys(reducers)
